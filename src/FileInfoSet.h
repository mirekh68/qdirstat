...
#ifndef IFileInfoSet_h
#define IFileInfoSet_h
...
{
    /**
     * Container for IFileInfo pointers. This is a wrapper around QSet with a
     * few add-on functions.
     **/
    class IFileInfoSet: public QSet<IFileInfo *>
    {
    public:
    IFileInfoSet():
        QSet<IFileInfo *>()
     ...
     * the set.
     **/
    bool containsAncestorOf( IFileInfo * item ) const;
